  ...
  en: {
    translation: {
      ...
      settings: {
        ...
        fieldUnit: "Unit Field",
        unitMappings: "Unit Value Mappings",
        unitMappingsHint: "Map API unit values to standard units",
        unitMappingFrom: "API value (e.g., gram, kilogram)",
        noUnitMappings: "No unit mappings defined. Add mappings to convert API values.",
      ...
      wizard: {
        ...
        selectProductsPerPage: "Please select products per page",
        pagesRequired: "Pages required",
        loadingCreating: "Creating campaign...",
        loadingProducts: "Adding products...",
        loadingImages: "Processing product images...",
        loadingFinalizing: "Finalizing and opening editor...",
      },
    },
  },
  tr: {
    translation: {
      ...
      editor: {
        ...
        datePlaceholder: "Tarih Yer Tutucusu",
        dateFormat: "Tarih Formati",
      ...
      settings: {
        ...
        fieldUnit: "Birim Alani",
        unitMappings: "Birim Deger Eslemeleri",
        unitMappingsHint: "API birim degerlerini standart birimlere esleyin",
        unitMappingFrom: "API degeri (orn: gram, kilogram)",
        noUnitMappings: "Birim eslemesi tanimlanmadi. API degerlerini donusturmek icin esleme ekleyin.",
      ...
      wizard: {
        ...
        selectProductsPerPage: "Lutfen sayfa basina urun sayisini secin",
        pagesRequired: "Gereken sayfa sayisi",
        loadingCreating: "Kampanya olusturuluyor...",
        loadingProducts: "Urunler ekleniyor...",
        loadingImages: "Urun resimleri isleniyor...",
        loadingFinalizing: "Sonlandirilip editor aciliyor...",
      },
    },
  },
  de: {
    translation: {
      ...
      wizard: {
        createCampaign: "Kampagne erstellen",
        selectTemplateType: "Vorlagentyp auswahlen",
        selectTemplate: "Vorlage auswahlen",
        setCampaignDates: "Kampagnendetails festlegen",
        selectProducts: "Produkte auswahlen",
        confirmCampaign: "Bestatigen und erstellen",
        campaignPrice: "Kampagnenpreis",
        discountPrice: "Rabattierter Preis",
        productsPerPage: "Produkte pro Seite",
        selectProductsPerPage: "Bitte wahlen Sie Produkte pro Seite aus",
        pagesRequired: "Erforderliche Seiten",
        loadingCreating: "Kampagne wird erstellt...",
        loadingProducts: "Produkte werden hinzugefugt...",
        loadingImages: "Produktbilder werden verarbeitet...",
        loadingFinalizing: "Finalisierung und Offnen des Editors...",
      },
    },
  },
};
